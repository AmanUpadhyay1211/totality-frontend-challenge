...
function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-12 pt-20 relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto p-4 relative z-10">
        ...
        <div className="flex justify-center space-x-4 mt-8">
          <Link href="https://github.com/AmanUpadhyay1211" target="_blank" rel="noopener noreferrer">
            <FaGithub className="text-white text-2xl hover:text-teal-500 transition-colors duration-200" />
          </Link>
          <Link href="https://www.linkedin.com/in/allthingsaman" target="_blank" rel="noopener noreferrer">
            <FaLinkedin className="text-white text-2xl hover:text-teal-500 transition-colors duration-200" />
          </Link>
          <Link href="https://instagram.com/allthingsaman" target="_blank" rel="noopener noreferrer">
            <FaInstagram className="text-white text-2xl hover:text-teal-500 transition-colors duration-200" />
          </Link>
          <Link href="http://twitter.com/AmanUpa59504263?s=09" target="_blank" rel="noopener noreferrer">
            <FaTwitter className="text-white text-2xl hover:text-teal-500 transition-colors duration-200" />
          </Link>
          <Link href="https://facebook.com/yourusername" target="_blank" rel="noopener noreferrer">
            <FaFacebook className="text-white text-2xl hover:text-teal-500 transition-colors duration-200" />
          </Link>
        </div>
      </div>
      <ToastContainer />
